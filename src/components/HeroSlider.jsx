...
const slides = [
  {
    ...
    image: <img alt="Groupe d'étudiants lisant la Bible ensemble" src="https://images.unsplash.com/photo-1567802927933-f10bc19cf850" />
  },
  {
    id: 2,
    title: "Etre à l'image du maître",
    image: <img alt="Bible ouverte avec lumière naturelle" src="https://images.unsplash.com/photo-1675047373408-2d64c81c0da6" />
  },
  {
    id: 3,
    title: "L'excellence au service du Royaume de Dieu",
    image: <img alt="Salle de classe moderne pour formation biblique" src="https://images.unsplash.com/photo-1573894998033-c0cef4ed722b" />
  }
];
          ...
          <div className="absolute inset-0 z-20 flex items-center justify-center">
            <div className="text-center px-4 max-w-4xl">
              <motion.h1
                ...
                className="text-5xl md:text-6xl font-serif font-bold text-white mb-4 leading-tight"
              >
